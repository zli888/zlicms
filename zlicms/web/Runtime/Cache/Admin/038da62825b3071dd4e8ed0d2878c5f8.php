...
<div class="main">
    ...
    <form name="CheckboxForm" action="" method="post">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <?php if(is_array($rule_list)): foreach($rule_list as $key=>$v): ?><tr onmousemove="javascript:this.bgColor='#d2e8fb';" onmouseout="javascript:this.bgColor='';">
                <td><?php echo ($v['id']); ?></td>
                <td><input name="id" type="checkbox" id="aid" value="<?php echo ($v['id']); ?>"></td>
                <td><?php echo ($v['sort']); ?></td>
                <td class="tL"><?php echo ($v['level']>1 ? '└' : ''); echo ($v['html']); echo ($v['title']); ?></td>
